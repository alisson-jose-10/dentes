...
const UrgencyNotification = () => {
  ...
  return (
    <div className={`fixed bottom-24 sm:bottom-6 left-3 sm:left-6 z-40 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-95'}`}>
      <div className="bg-red-600 text-white px-3 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl shadow-2xl max-w-xs sm:max-w-sm border-l-4 sm:border-l-8 border-red-400 animate-pulse">
        <div className="flex items-center gap-2 sm:gap-3">
          <Flame className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 animate-bounce" />
